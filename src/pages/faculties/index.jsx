...
export default function UsersIndex() {
    ...
    const[faculties, setUsers] = useState([]);
    ...
    const fetchData = async (pageNumber=1, keywords='') => {
        ...
        await Api.get(`/api/admin/faculties?search=${keywords}&page=${page}`, {
            //header
            headers: {
                //header Bearer + Token
                                        ...
                                        <tbody>
                                            {
                                                ...
                                                //looping data "faculties" dengan "map"
                                                ?   faculties.map((faculty, index) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td className="text-center">
                                                                  ...
                                                                  <Link to={`/faculties/edit/${faculty.id}`} className="btn btn-primary btn-sm"><i className="fa fa-pencil-alt"></i></Link>
